...
import { FormInput, FormImage } from "./styled-components/Components";
...
const ImageUpload = ({
  ...
  return (
    <>
      ...
      >
        {image?.src ? (
          <AiFillCheckCircle style={{ width: "100px", height: "40px" }} />
        ) : null}

        <div className="flex items-center justify-center">
          {!image?.src ? (
            <div className="flex flex-col items-center space-y-2">
              <div className="shrink-0 rounded-full p-2 bg-gray-200 group-hover:scale-110 group-focus:scale-110 transition"></div>
